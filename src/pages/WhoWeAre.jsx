   ...
   <main>
      ...
      <section className="historia">
        <div className="historia-box">
          ...
          <br />Com a ajuda de pessoas cheias de fé e ousadia, que alugaram um espaço, arrumaram cadeiras, instrumentos musicais e organizaram um culto, surgiu a Igreja Novo Tempo. <br />Desde o início, esse ministério tem crescido com propósito e dedicação, impactando famílias e reacendendo a fé em muitos corações.
          ...
          <p>
            Sob a liderança dos bispos Samuel e Thaís, a igreja se tornou um lugar de acolhimento, ensino e avivamento. Com suas três filhas — Emanuelle, Danielle e Letícia — o casal vive o chamado com intensidade e entrega.<br /> Thaís, bióloga de formação, hoje neuropsicopedagoga e terapeuta, e Samuel, ex-supervisor de vendas, deixaram suas carreiras para servir em tempo integral no Reino de Deus, assumindo com coragem e fé a missão de conduzir pessoas ao encontro com Cristo.
          </p>

          <h3 className="sub-titulo">Nossa Identidade</h3>
          <p>
            A trajetória da Novo Tempo é marcada por crescimento, não apenas em número, mas em profundidade espiritual. São vidas restauradas, famílias reerguidas e corações renovados. A igreja se firmou como uma voz profética na cidade, apontando sempre para Jesus como único caminho, verdade e vida.
            <br />
      ...
      <section className="pastors-section">
        <h2 className="sub-titulo">🙏 Conheça nossos pastores</h2>
        <div className="pastors-container">
          {[
            {
              img: "/images/bispos.jpg",
              nome: "Bispo Samuel e Bispa Thais",
              texto:
            ...
            {
              img: "/images/deboraecaio.jpg",
              nome: "Pastor Caio e Pastora Débora",
              texto:
            ...
            {
              img: "/images/ricardoepatricia.jpg",
              nome: "Pastor Ricardo e Pastora Patricia",
              texto:
            ...
            {
              img: "/images/renatoebarbara.jpg",
              nome: "Pastor Renato e Pastora Barbara",
              texto:
                "Nosso chamado pastoral nasceu do desejo profundo de servir a Deus e cuidar de pessoas. Entendemos que a vida cristã vai além de palavras — ela se expressa no amor, na escuta, na presença e no compromisso com cada vida.\n\nSomos pastores por vocação, por convicção e por compaixão. Deus nos chamou para edificar uma comunidade de fé onde todos possam encontrar cura, direção e esperança.\n\nNosso coração pulsa por vidas transformadas pela graça de Jesus. Queremos caminhar com você, celebrar suas vitórias e estender a mão nas suas lutas. Estamos aqui para ouvir, ensinar, orar e, acima de tudo, amar."
            },
            {
              img: "./images/valdeci.jpg",
              nome: "Pastor Valdeci",
              texto:
                "Nosso chamado pastoral nasceu do desejo profundo de servir a Deus e cuidar de pessoas. Entendemos que a vida cristã vai além de palavras — ela se expressa no amor, na escuta, na presença e no compromisso com cada vida.\n\nSomos pastores por vocação, por convicção e por compaixão. Deus nos chamou para edificar uma comunidade de fé onde todos possam encontrar cura, direção e esperança.\n\nNosso coração pulsa por vidas transformadas pela graça de Jesus. Queremos caminhar com você, celebrar suas vitórias e estender a mão nas suas lutas. Estamos aqui para ouvir, ensinar, orar e, acima de tudo, amar."
            },
            {
              img: "/images/Eduardoedani.jpg",
              nome: "Pastor Eduardo e Pastora Dani",
              texto:
                "Nosso chamado pastoral nasceu do desejo profundo de servir a Deus e cuidar de pessoas. Entendemos que a vida cristã vai além de palavras — ela se expressa no amor, na escuta, na presença e no compromisso com cada vida.\n\nSomos pastores por vocação, por convicção e por compaixão. Deus nos chamou para edificar uma comunidade de fé onde todos possam encontrar cura, direção e esperança.\n\nNosso coração pulsa por vidas transformadas pela graça de Jesus. Queremos caminhar com você, celebrar suas vitórias e estender a mão nas suas lutas. Estamos aqui para ouvir, ensinar, orar e, acima de tudo, amar."
            }
          ].map((pastor, index) => (
            <div className="pastor" key={index}>
              <img src={pastor.img} alt={pastor.nome} />
              <h3>{pastor.nome}</h3>
              <p>{pastor.texto}</p>
            </div>
          ))}
